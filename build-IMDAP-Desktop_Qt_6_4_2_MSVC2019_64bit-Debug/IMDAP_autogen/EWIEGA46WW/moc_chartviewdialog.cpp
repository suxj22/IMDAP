...
namespace {
struct qt_meta_stringdata_ChartViewDialog_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ChartViewDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ChartViewDialog_t qt_meta_stringdata_ChartViewDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ChartViewDialog[] = {
...
Q_CONSTINIT const QMetaObject ChartViewDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ChartViewDialog.offsetsAndSizes,
    qt_meta_data_ChartViewDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ChartViewDialog_t,
        // Q_OBJECT / Q_GADGET
...
void *ChartViewDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChartViewDialog.stringdata0))
