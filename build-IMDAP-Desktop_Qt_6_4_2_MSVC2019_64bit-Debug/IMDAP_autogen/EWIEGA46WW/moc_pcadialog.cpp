...
namespace {
struct qt_meta_stringdata_PCADialog_t {
    uint offsetsAndSizes[2];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PCADialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PCADialog_t qt_meta_stringdata_PCADialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_PCADialog[] = {
...
Q_CONSTINIT const QMetaObject PCADialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_PCADialog.offsetsAndSizes,
    qt_meta_data_PCADialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PCADialog_t,
        // Q_OBJECT / Q_GADGET
...
void *PCADialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PCADialog.stringdata0))
